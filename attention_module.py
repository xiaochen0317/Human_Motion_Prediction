...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, q, k, v, mask=None):
        ...
        q, attn = self.attention(q, k, v, mask=mask)  # (bz, n, lq, dv) (bz, n, lq, lv)
...
class Encoder(nn.Module):
    ...
    def __init__(self, n_src_vocab, d_word_vec, n_layers, n_head, d_k, d_v, d_model, d_inner, pad_idx, dropout=0.1,
                 n_position=200):
        super().__init__()
        # Embedding
...
class Decoder(nn.Module):
    ...
    def __init__(self, n_trg_vocab, d_word_vec, n_layers, n_head, d_k, d_v, d_model, d_inner, pad_idx, n_position=200,
                 dropout=0.1):
        super().__init__()
